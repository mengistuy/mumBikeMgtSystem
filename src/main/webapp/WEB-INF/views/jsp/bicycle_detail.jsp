...
<body>
	...
	<div class="container main-container">
		...
		<div>Model:- ${bicycle.model }</div>
		<div>Color:- ${bicycle.color }</div>
		<div>Make:- ${bicycle.make }</div>
		<div>Size:- ${bicycle.size }</div>
			...
			<tbody>
				<c:forEach items="${bicycleList }" var="bicycle">
					<tr>
						...
						<td><spring:url
								value="/bicycle/donateBicycle/${bicycle.bicycleId }"
								var="donateURL" /> <a class="btn btn-primary"
							href="${donateURL }" role="button">Donate</a></td>
						<td><spring:url
